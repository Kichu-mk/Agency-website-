...
const Services = () => {
    ...
    const servicesData = [
        ...
        {
            title: 'Conetent writing' ,
            description: 'We help you create a marketing strategy that drives reuslts ',
    ...
    return (
        ...
        sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            <img src={assets.bgImage2}  alt="" className="absolute -top-110 -left-70 -z-z dark:hidden" />
