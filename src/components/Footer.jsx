...
const Footer = ( {theme} ) => {
    return (
        ...
        <div className='bg-slate-100 sm:w-[95%] rounded-t-lg dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4
        sm:px-10 lg:px-24 xl:px-40 '>
            <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
                <div className="space-y-5 text-sm text-gray-700 dark:text-gray-400">
                    ...
                    <p className="max-w-md">Form strategy to execution, we craft digital 
