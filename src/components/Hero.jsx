...
const Hero = () => {
    return (
        <div>
            ...
            dark:text-white'>
                <div className='inline-flex items-center border border-gray-300 p-1 
                ...
                xl:leading-[95px] max-w-5xl">Turning imagination into 
                <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text 
                text-transparent' > Digital</span> impact</h1>

                <p className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75
                 max-w-4/5 sm:max-w-lg pb-3">Creating meaningful connecton and turning big ideas
                    into intractive digital experience.
                </p>

                <div className="relative">
                    <img src={assets.hero_img} alt="" className="w-full max-w-6xl" />
                    <img src={assets.bgImage1} alt="" className='absolute -top-40 -rihgt-40
